                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="../../view/cadastroJogos/cadastroJogos.php">Cadastrar novo Jogo</a></li>
                                <li><a class="dropdown-item" href="#">Listar Jogos Adicionados</a></li>
                                <li>
